...
QT_MOC_LITERAL(2, 29, 0) // ""
    ...
    "Insert\0on_pushButton_clicked\0"
};
...
void Insert::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Insert *_t = static_cast<Insert *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject Insert::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Insert.data,
      qt_meta_data_Insert,  qt_static_metacall, nullptr, nullptr}
};
